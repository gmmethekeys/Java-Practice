...
public class Marovich_A05Q4
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Testing pushLast method: \n");
    ...
    public static class LinkedStack<T> implements StackADT<T>
    {
        ...
        public void pushLast(T element) {
            ...
            //gets the next node from bottom and checks to see if null
            while (bottom.getNext() != null) {
                
                //reassigns link for bottom node to next node
                bottom = bottom.getNext(); 
            }
            
            //tells where to go next after bottom
            bottom.setNext(temp);
            count++;
        }
